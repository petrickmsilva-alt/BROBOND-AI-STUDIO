...
export default function Home() {
  ...
  return <main className="app-shell">
    <aside className={`sidebar ${sidebar ? '' : 'collapsed'}`}>
      ...
      <nav><button onClick={() => router.push('/studio/personas')}><UserRound size={18} /><span>Persona profiles</span><b className="nav-badge">SQL</b></button><button onClick={() => router.push('/studio/knowledge')}><Network size={18} /><span>Knowledge</span><b className="nav-badge">GRAPH</b></button><button onClick={() => router.push('/studio/continuity')}><Film size={18} /><span>Continuity</span><b className="nav-badge">V3.2</b></button><button onClick={() => router.push('/studio/campaigns')}><Megaphone size={18} /><span>Campaigns</span><b className="nav-badge">V3.3</b></button><button onClick={() => setActive('assets')}><Library size={18} /><span>All assets</span></button></nav>
