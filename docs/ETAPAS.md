...
| Métrica | Valor |
| --- | --- |
| Suíte de testes | **1.495** |
| Cobertura `backend/app` | **97%** (gate CI: 95%) |
| Módulos em 100% | **59** |
| Rotas HTTP `/api/v1` | **86** — **33** delas `/api/v1/core/*` |
| WebSockets | **3** |
