...
| Métrica | Valor |
| --- | --- |
| Suíte de testes | **1.324** |
| Cobertura `backend/app` | **96%** (gate CI: 95%) |
| Módulos em 100% | **51** |
| Rotas HTTP `/api/v1` | **72** — **32** delas `/api/v1/core/*` |
| WebSockets | **3** |
